...
from TCN.soil_classification.model_AE import DenseAE
...
if __name__ == "__main__":
    ...
    train_loss = []
    test_loss = []
    model_name = "DenseAEL1_bs"+str(batch_size)+"_do"+str(int(dropout*100))+"_seq"+str(seq_len)+"_"+val_mask_name+"_phase"+str(phase)+"_nlf"+str(latent_dim)
