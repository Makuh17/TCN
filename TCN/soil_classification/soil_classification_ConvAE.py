...
if __name__ == "__main__":
    ...
    channel_sizes = [30,30,30,30,30,4]#[nhid]*levels #
    kernel_size = ksize
    ...
    train_loss = []
    test_loss = []
    model_name = "ConvAE_bs"+str(batch_size)+"_do"+str(int(dropout*100))+"_seq"+str(seq_len)+"_"+val_mask_name+"_phase"+str(phase)+"_nlf"+str(latent_dim)
