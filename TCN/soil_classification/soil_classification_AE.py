...
from TCN.soil_classification.model_AE import TCNAE, TCNAERevDialation, DenseTCNAE
...
if __name__ == "__main__":
    ...
    model = DenseTCNAE(input_channels, latent_dim, seq_len, channel_sizes, kernel_size=kernel_size, dropout=dropout)
