...
from TCN.soil_classification.model_AE import TCNAE, TCNAERevDialation, DenseTCNAE, DenseLastTCNAE
...
if __name__ == "__main__":
    ...
    model = DenseLastTCNAE(input_channels, 10, seq_len, channel_sizes, kernel_size=kernel_size, dropout=dropout)
    ...
    train_loss = []
    test_loss = []
    model_name = "Dense_bs"+str(batch_size)+"_do"+str(int(dropout*100))+"_seq"+str(seq_len)+"_"+val_mask_name+"_phase"+str(phase)+"_nlf"+str(latent_dim)
